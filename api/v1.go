...
func createLobby(w http.ResponseWriter, r *http.Request) {
    ...
    var playerImage = "resources/character1.png"
	player, lobby, createError := game.CreateLobby(playerName, playerImage, language, publicLobby, drawingTime, rounds, maxPlayers, customWordChance, clientsPerIPLimit, customWords, enableVotekick)
	if createError != nil {
